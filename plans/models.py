...
class Plan(models.Model):
    ...
    weekly_price = models.CharField(max_length=16, default='0')
    ...
    tax_percentage = models.CharField(max_length=16, null=True, blank=True)
...
class SubscribedPlan(models.Model):
    ...
    no_of_video_session = models.IntegerField(default=0)
    is_doctor_changed = models.IntegerField(default=0)
    doctor_price = models.CharField(max_length=16, null=True, blank=True)
    ...
    company_coupon_type = models.IntegerField(default=0)
    ...
    upcoming_plan_video_credit = models.IntegerField(default=0)
    incentive_days = models.IntegerField(default=0)
    value = models.TextField(null=True, blank=True)
    rezorpay_start_time = models.DateTimeField(null=True, blank=True)
    start_at = models.DateTimeField(null=True, blank=True)
    end_at = models.DateTimeField(null=True, blank=True)
    trail_end_time = models.DateTimeField(null=True, blank=True)
...
class Coupon(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='coupons')
...
class WebhookLog(models.Model):
    ...
    class Meta:
        db_table = 'tbl_subscription_event_log'
